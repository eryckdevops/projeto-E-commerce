            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <span class="copyright">{{ config('app.name') }} &copy; {{ date('Y') }} Todos os direitos reservados | Site desenvolvido por <a href="https://ryan-menezes.github.io/" target="_blank" title="Portfólio do Desenvolvedor" style="color: #fff;">Erick Rodrigues</a></span>
                    </div>
                </div>
                    <!-- /row -->
            </div>
